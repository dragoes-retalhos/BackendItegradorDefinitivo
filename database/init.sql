...
CREATE TABLE IF NOT EXISTS `mydb`.`attachment` (
  ...
  `laboratory_item_id_laboratory_item_heritage` INT(11) NULL DEFAULT NULL,
  `maintenance_id_maintenance` INT(11) NULL DEFAULT NULL,
...
CREATE VIEW unique_brands_models AS
SELECT DISTINCT
    brand,
    model
FROM laboratory_item
...
SELECT 
    ...
    l.loan_date AS loan_date,  -- Sem formatação, retorna o tipo DATETIME
    l.expected_return_date AS expected_return_date,  -- Sem formatação, retorna o tipo DATE
